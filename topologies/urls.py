...
urlpatterns = patterns('',
	...
	url(r'^manageKvm/viewNetwork/(?P<network_name>\w+)$', views.viewNetwork, name='viewNetwork'),
	url(r'^manageKvm/startNetwork/(?P<network_name>\w+)/$', views.startNetwork, name='startNetwork'),
	url(r'^manageKvm/stopNetwork/(?P<network_name>\w+)/$', views.stopNetwork, name='stopNetwork'),
	url(r'^manageKvm/undefineNetwork/(?P<network_name>\w+)/$', views.undefineNetwork, name='undefineNetwork'),
)
